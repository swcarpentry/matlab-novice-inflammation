...
We now know one way to test our code, but it's hard to redo.
A better way of making sure our code does what we ask is to use something 
called [assertions](../../gloss.html#assertion).
